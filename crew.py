...
then the style artist with the character-sheet artist, mise-en-scene and the storyboarder,
then the asset maker with three agents checking what it made through three different lenses.
`paperreel/crew.py` is the order and the reasons.
