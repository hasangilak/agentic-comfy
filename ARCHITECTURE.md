...
Setup, running the studio, and the CLI live in [README.md](README.md). This file is *why*
the joins, fingerprints, crew, and costs are what they are. Read it before changing
render behaviour, prompt scaffolding, or money.
