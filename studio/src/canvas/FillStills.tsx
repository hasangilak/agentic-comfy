 ...
 *
 * Uploading does not call the image service, and a board set to "my own" cannot generate at all.
 * Generating uses Gemini through the image server, and only while that server is actually up,
 * so the copy below follows
    ...
    >
            ...
            <button
              ...
              title={
                manual
                  ...
                  : local
                    ? "stills are generated from each beat's asset_prompt by Gemini, then " +
                      "checked against the cast reference"
      ...
      <p className="text-[10px] leading-snug text-zinc-500">
        ...
        {board.manual_stills
          ...
          : local
            ? " · generated by Gemini and checked against the cast reference"
      ...
      <Button
        ...
        title="pick or drop several images at once"
      >
        {busy
