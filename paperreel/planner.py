                ...
                "properties": {
                    ...
                    "action": {
                        ...
                        "description": (
                            ...
                            "pose the clip arrives at and holds. A third expression or "
                            "gesture is another 5 s beat, not a denser 10 s -- split, do not "
                            "pack. Do not write that nothing changes, or that a face holds "
                            "still (that freeze leaks). Do not write a state morphing into "
                            "another; hide the change or cut. Do not shoot a collision or "
                            "the volume of a liquid. Do NOT add a pan, tilt, push, or "
                            "dialogue -- dialogue does not make faces move. Do NOT restate "
                            "materials, colours, markings, or construction -- those live in "
                            "style_bible and reference pictures; restating them with drift "
                            "invents a second puppet mid-clip. On a same-shot continuation "
                            "(reference after the opening beat, or chain/bridge), open with "
                            "a continuity phrase and pick up the exact end-state of the beat "
                            "before; on bridge, finish in the state asset_prompt describes."
                        ),
                    },
                    "asset_prompt": {
                        "type": "string",
